...
const SignUpForm = () => {
  ...
  const handleRegister = async (e) =>{
    ...
    if(password !== controlPassword || !terms.checked){
      ...
      if(!terms.checked){
        termsError.innerHTML = "Veuillez accepter les CGU";
      }
    } else {
      await axios({
        method: "post",
  ...
  return (
    ...
    {formSubmit? (
      ...
      <form action="" onSubmit={handleRegister} id='signUpForm'>
        ...
        <br/>
        <input type='password' name='password-conf' id='password-cinf' onChange={(e)=> setControlPassword(e.target.value)} value={controlPassword}/>
